module.exports = (req, res, next) => {
  if (req.url.startsWith("/report") && req.method === "GET") {
    ...
    console.log(report.totalSum);
    report.listProductFromReport = Object.keys(revenueByProduct).map((productId) => ({
